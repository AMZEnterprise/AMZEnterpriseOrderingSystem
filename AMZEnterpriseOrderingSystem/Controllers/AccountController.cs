...
using AMZEnterpriseOrderingSystem.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "تلاش برای ورود ناموفق می باشد");
                    return View(model);
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //if (user.Email == "admin@gmail.com" && user.PhoneNumber == "1112223333" && user.FirstName == "Admin" && user.LastName == "Ali")
                    //{
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            if (remoteError != null)
            {
                ErrorMessage = $"خطای سرویس خارجی: {remoteError}";
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "تعویض کلمه عبور",
                   $"برای تعویض کلمه عبور بر روی لینک کلیک کنید: <a href='{callbackUrl}'>لینک</a>");
                return RedirectToAction(nameof(ForgotPasswordConfirmation));
            }
